...
function change(v) {
    ...
    var vs = document.getElementById("proviceHidden");
    var vsvalue="";
    if(vs){
    	vsvalue = vs.value;
    }
...
function change1(v) {
    ...
    var id = s1[v]+"1Hidden";
    var sss = document.getElementById(id);
    var vs = document.getElementById("provice1Hidden");
    var vsvalue="";
    if(vs){
    	vsvalue = vs.value;
    }
...
dsy.add("0", ["北京市", "天津市", "河北省", "山西省", "内蒙古自治区", "辽宁省", "吉林省", "黑龙江省",
...
dsy.add("0_1", ["天津市市辖区", "天津市郊县"]);
dsy.add("0_1_0", ["和平区","河东区","河西区","南开区","河北区","红桥区","东丽区","西青区","津南区","北辰区","武清区","宝坻区","滨海新区","宁河区","静海区","蓟县"]);
dsy.add("0_1_1", ["天津市郊县"]);


dsy.add("0_2",["石家庄市","唐山市","秦皇岛市","邯郸市","邢台市","保定市","张家口市","承德市","沧州市","廊坊市","衡水市"]);
dsy.add("0_2_0",["长安区","桥西区","新华区","井陉矿区","裕华区","藁城区","鹿泉区","栾城区","井陉县","正定县","行唐县","灵寿县","高邑县","深泽县","赞皇县","无极县","平山县","元氏县","赵县","辛集市","晋州市","新乐市"]);
dsy.add("0_2_1",["路南区","路北区","古冶区","开平区","丰南区","丰润区","曹妃甸区","滦县","滦南县","乐亭县","迁西县","玉田县","遵化市","迁安市"]);
dsy.add("0_2_2",["海港区","山海关区","北戴河区","抚宁区","青龙满族自治县","昌黎县","卢龙县"]);
...
dsy.add("0_2_5",["竞秀区","莲池区","满城区","清苑区","徐水区","涞水县","阜平县","定兴县","唐县","高阳县","容城县","涞源县","望都县","安新县","易县","曲阳县","蠡县","顺平县","博野县","雄县","涿州市","定州市","安国市","高碑店市"]);
...
dsy.add("0_4",["呼和浩特市","包头市","乌海市","赤峰市","通辽市","鄂尔多斯市","呼伦贝尔市","巴彦淖尔市","乌兰察布市","兴安盟","锡林郭勒盟","阿拉善盟"]);
...
dsy.add("0_5_1",["中山区","西岗区","沙河口区","甘井子区","旅顺口区","金州区","普兰店区","长海县","瓦房店市","庄河市"]);
...
dsy.add("0_6",["长春市","吉林市","四平市","辽源市","通化市","白山市","松原市","白城市","延边朝鲜族自治州"]);
dsy.add("0_6_0",["南关区","宽城区","朝阳区","二道区","绿园区","双阳区","九台区","农安县","榆树市","德惠市"]);
...
dsy.add("0_7",["哈尔滨市","齐齐哈尔市","鸡西市","鹤岗市","双鸭山市","大庆市","伊春市","佳木斯市","七台河市","牡丹江市","黑河市","绥化市","大兴安岭地区"]);
dsy.add("0_7_0",["道里区","南岗区","道外区","平房区","松北区","香坊区","呼兰区","阿城区","双城区","依兰县","方正县","宾县","巴彦县","木兰县","通河县","延寿县","尚志市","五常市"]);
...
dsy.add("0_7_7",["向阳区","前进区","东风区","郊区","桦南县","桦川县","汤原县","抚远市","同江市","富锦市"]);
dsy.add("0_7_8",["新兴区","桃山区","茄子河区","勃利县"]);
dsy.add("0_7_9",["东安区","阳明区","爱民区","西安区","林口县","绥芬河市","海林市","宁安市","穆棱市","东宁市"]);
...
dsy.add("0_8",["上海市市辖区","上海市郊县"]);
dsy.add("0_8_0",["黄浦区","徐汇区","长宁区","静安区","普陀区","虹口区","杨浦区","闵行区","宝山区","嘉定区","浦东新区","金山区","松江区","青浦区","奉贤区","崇明县"]);
dsy.add("0_8_1",["上海市郊县"]);
...
dsy.add("0_9_1",["锡山区","惠山区","滨湖区","梁溪区","新吴区","江阴市","宜兴市"]);
dsy.add("0_9_2",["鼓楼区","云龙区","贾汪区","泉山区","铜山区","丰县","沛县","睢宁县","新沂市","邳州市"]);
dsy.add("0_9_3",["天宁区","钟楼区","新北区","武进区","金坛区","溧阳市"]);
...
dsy.add("0_9_8",["亭湖区","盐都区","大丰区","响水县","滨海县","阜宁县","射阳县","建湖县","东台市"]);
...
dsy.add("0_10_0",["上城区","下城区","江干区","拱墅区","西湖区","滨江区","萧山区","余杭区","富阳区","桐庐县","淳安县","建德市","临安市"]);
dsy.add("0_10_1",["海曙区","江东区","江北区","北仑区","镇海区","鄞州区","象山县","宁海县","余姚市","慈溪市","奉化市"]);
dsy.add("0_10_2",["鹿城区","龙湾区","瓯海区","洞头区","永嘉县","平阳县","苍南县","文成县","泰顺县","瑞安市","乐清市"]);
dsy.add("0_10_3",["南湖区","秀洲区","嘉善县","海盐县","海宁市","平湖市","桐乡市"]);
dsy.add("0_10_4",["吴兴区","南浔区","德清县","长兴县","安吉县"]);
dsy.add("0_10_5",["越城区","柯桥区","上虞区","新昌县","诸暨市","嵊州市"]);
...
dsy.add("0_11",["合肥市","芜湖市","蚌埠市","淮南市","马鞍山市","淮北市","铜陵市","安庆市","黄山市","滁州市","阜阳市","宿州市","六安市","亳州市","池州市","宣城市"]);
...
dsy.add("0_11_3",["大通区","田家庵区","谢家集区","八公山区","潘集区","凤台县","寿县"]);
dsy.add("0_11_4",["花山区","雨山区","博望区","当涂县","含山县","和县"]);
dsy.add("0_11_5",["杜集区","相山区","烈山区","濉溪县"]);
dsy.add("0_11_6",["铜官区","义安区","郊区","枞阳县"]);
dsy.add("0_11_7",["迎江区","大观区","宜秀区","怀宁县","潜山县","太湖县","宿松县","望江县","岳西县","桐城市"]);
...
dsy.add("0_11_12",["金安区","裕安区","叶集区","霍邱县","舒城县","金寨县","霍山县"]);
...
dsy.add("0_12_6",["延平区","建阳区","顺昌县","浦城县","光泽县","松溪县","政和县","邵武市","武夷山市","建瓯市"]);
dsy.add("0_12_7",["新罗区","永定区","长汀县","上杭县","武平县","连城县","漳平市"]);
dsy.add("0_12_8",["蕉城区","霞浦县","古田县","屏南县","寿宁县","周宁县","柘荣县","福安市","福鼎市"]);

dsy.add("0_13",["南昌市","景德镇市","萍乡市","九江市","新余市","鹰潭市","赣州市","吉安市","宜春市","抚州市","上饶市"]);
dsy.add("0_13_0",["东湖区","西湖区","青云谱区","湾里区","青山湖区","新建区","南昌县","安义县","进贤县"]);
...
dsy.add("0_13_6",["章贡区","南康区","赣县","信丰县","大余县","上犹县","崇义县","安远县","龙南县","定南县","全南县","宁都县","于都县","兴国县","会昌县","寻乌县","石城县","瑞金市"]);
...
dsy.add("0_13_10",["信州区","广丰区","上饶县","玉山县","铅山县","横峰县","弋阳县","余干县","鄱阳县","万年县","婺源县","德兴市"]);
...
dsy.add("0_14_7",["任城区","兖州区","微山县","鱼台县","金乡县","嘉祥县","汶上县","泗水县","梁山县","曲阜市","邹城市"]);
...
dsy.add("0_14_15",["滨城区","沾化区","惠民县","阳信县","无棣县","博兴县","邹平县"]);
dsy.add("0_14_16",["牡丹区","曹县","单县","成武县","巨野县","郓城县","鄄城县","定陶县","东明县"]);

dsy.add("0_15",["郑州市","开封市","洛阳市","平顶山市","安阳市","鹤壁市","新乡市","焦作市","濮阳市","许昌市","漯河市","三门峡市","南阳市","商丘市","信阳市","周口市","驻马店市","济源市"]);
dsy.add("0_15_0",["中原区","二七区","管城回族区","金水区","上街区","惠济区","中牟县","巩义市","荥阳市","新密市","新郑市","登封市"]);
dsy.add("0_15_1",["龙亭区","顺河回族区","鼓楼区","禹王台区","祥符区","杞县","通许县","尉氏县","兰考县"]);
...
dsy.add("0_15_11",["湖滨区","陕州区","渑池县","卢氏县","义马市","灵宝市"]);
...
dsy.add("0_15_17",["济源市区"]);

dsy.add("0_16",["武汉市","黄石市","十堰市","宜昌市","襄阳市","鄂州市","荆门市","孝感市","荆州市","黄冈市","咸宁市","随州市","恩施土家族苗族自治州","仙桃市","潜江市","天门市","神农架林区"]);
...
dsy.add("0_16_13",["仙桃市区"]);
dsy.add("0_16_14",["潜江市区"]);
dsy.add("0_16_15",["天门市区"]);
dsy.add("0_16_16",["神农架林区"]);

dsy.add("0_17",["长沙市","株洲市","湘潭市","衡阳市","邵阳市","岳阳市","常德市","张家界市","益阳市","郴州市","永州市","怀化市","娄底市","湘西土家族苗族自治州"]);
...
dsy.add("0_18_0",["荔湾区","越秀区","海珠区","天河区","白云区","黄埔区","番禺区","花都区","南沙区","从化区","增城区"]);
...
dsy.add("0_18_9",["端州区","鼎湖区","高要区","广宁县","怀集县","封开县","德庆县","四会市"]);
...
dsy.add("0_19_9",["右江区","田阳县","田东县","平果县","德保县","那坡县","凌云县","乐业县","田林县","西林县","隆林各族自治县","靖西市"]);
...
dsy.add("0_20",["海口市","三亚市","三沙市","儋州市","五指山市","琼海市","文昌市","万宁市","东方市","定安县","屯昌县","澄迈县","临高县","白沙黎族自治县","昌江黎族自治县","乐东黎族自治县","陵水黎族自治县","保亭黎族苗族自治县","琼中黎族苗族自治县"]);
dsy.add("0_20_0",["秀英区","龙华区","琼山区","美兰区"]);
dsy.add("0_20_1",["三亚湾","海棠区","吉阳区","天涯区","崖州区"]);
dsy.add("0_20_2",["西沙群岛","南沙群岛","中沙群岛的岛礁及其海域"]);
dsy.add("0_20_3",["儋州市区"]);
dsy.add("0_20_4",["五指山市区"]);
dsy.add("0_20_5",["琼海市区"]);
dsy.add("0_20_6",["文昌市区"]);
dsy.add("0_20_7",["万宁市区"]);
dsy.add("0_20_8",["东方市区"]);
dsy.add("0_20_9",["定安县区"]);
dsy.add("0_20_10",["屯昌县区"]);
dsy.add("0_20_11",["澄迈县区"]);
dsy.add("0_20_12",["临高县区"]);
...
dsy.add("0_21",["重庆市市辖区"]);
dsy.add("0_21_0",["万州区","涪陵区","渝中区","大渡口区","江北区","沙坪坝区","九龙坡区","南岸区","北碚区","綦江区","大足区","渝北区","巴南区","黔江区","长寿区","江津区","合川区","永川区","南川区","璧山区","铜梁区","潼南区","荣昌区","梁平县","城口县","丰都县","垫江县","武隆县","忠县","开县","云阳县","奉节县","巫山县","巫溪县","石柱土家族自治县","秀山土家族苗族自治县","酉阳土家族苗族自治县","彭水苗族土家族自治县"]);

dsy.add("0_22",["成都市","自贡市","攀枝花市","泸州市","德阳市","绵阳市","广元市","遂宁市","内江市","乐山市","南充市","眉山市","宜宾市","广安市","达州市","雅安市","巴中市","资阳市","阿坝藏族羌族自治州","甘孜藏族自治州","凉山彝族自治州"]);

dsy.add("0_22_0",["锦江区","青羊区","金牛区","武侯区","成华区","龙泉驿区","青白江区","新都区","温江区","双流区","金堂县","郫县","大邑县","蒲江县","新津县","都江堰市","彭州市","邛崃市","崇州市"]);
...
dsy.add("0_22_11",["东坡区","彭山区","仁寿县","洪雅县","丹棱县","青神县"]);
...
dsy.add("0_24_2",["红塔区","江川区","澄江县","通海县","华宁县","易门县","峨山彝族自治县","新平彝族傣族自治县","元江哈尼族彝族傣族自治县"]);
...
dsy.add("0_25",["拉萨市","日喀则市","昌都市","林芝市","山南地区","那曲地区","阿里地区"]);
dsy.add("0_25_0",["城关区","堆龙德庆区","林周县","当雄县","尼木县","曲水县","达孜县","墨竹工卡县"]);
...
dsy.add("0_26_4",["临渭区","华州区","潼关县","大荔县","合阳县","澄城县","蒲城县","白水县","富平县","韩城市","华阴市"]);
...
dsy.add("0_26_7",["榆阳区","横山区","神木县","府谷县","靖边县","定边县","绥德县","米脂县","佳县","吴堡县","清涧县","子洲县"]);
...
dsy.add("0_28",["西宁市","海东市","海北藏族自治州","黄南藏族自治州",
...
dsy.add("0_28_7",["格尔木市","德令哈市","乌兰县","都兰县","天峻县","海西蒙古族藏族自治州直辖"]);
...
dsy.add("0_30",["乌鲁木齐市","克拉玛依市","吐鲁番市","哈密地区","昌吉回族自治州","博尔塔拉蒙古自治州","巴音郭楞蒙古自治州","阿克苏地区","克孜勒苏柯尔克孜自治州","喀什地区","和田地区","伊犁哈萨克自治州","塔城地区","阿勒泰地区","石河子市","阿拉尔市","图木舒克市","五家渠市","北屯市","铁门关市","双河市","可克达拉市"]);
...
dsy.add("0_30_14",["石河子市"]);
dsy.add("0_30_15",["阿拉尔市"]);
dsy.add("0_30_16",["图木舒克市"]);
dsy.add("0_30_17",["五家渠市"]);
dsy.add("0_30_18",["北屯市"]);
dsy.add("0_30_19",["铁门关市"]);
dsy.add("0_30_20",["双河市"]);
dsy.add("0_30_21",["可克达拉市"]);


dsy.add("0_31",["台湾省辖区"]);
dsy.add("0_31_0",["新北市","基隆市","台中市","新竹市","台南市","嘉义市","台北县","台东县","澎湖县","花莲县","屏东县","高雄县","台南县","嘉义县","彰化县","云林县","南投县","台中县","苗栗县","桃园县","宜兰县","新竹县"]);

dsy.add("0_32",["香港特别行政区"]);
dsy.add("0_32_0",["中西区","湾仔区","东区","南区","油尖旺区","深水埗区","九龙城区","黄大仙区","观塘区","荃湾区","屯门区","元朗区","北区","大埔区","西贡区","沙田区","葵青区","离岛区"]);

dsy.add("0_33",["澳门特别行政区"]);
dsy.add("0_33_0",["花地玛堂区","花王堂区","望德堂区","大堂区","风顺堂区","嘉模堂区","路凼填海区","圣方济各堂区"]);

var s = ["province", "city", "district"];
var s1 = ["province1", "city1", "district1"]
...
function setup() {
    ...
    for (i = 0; i < s1.length - 1; i++){
    	if(document.getElementById(s1[i])){
