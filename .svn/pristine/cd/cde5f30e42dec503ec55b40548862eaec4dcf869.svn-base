...
public abstract class UmengNotification {
    ...
    public void setAfterOpen(String action) throws Exception{
    	setPredefinedKeyValue("after_open", action);
    }
    public void setUrl(String url) throws Exception{
    	setPredefinedKeyValue("url", url);
    }
    public void setPlayVibrate(Boolean play_vibrate) throws Exception{
    	setPredefinedKeyValue("play_vibrate", play_vibrate);
    	
    }
    public void setPlaySound(Boolean play_sound) throws Exception{
    	setPredefinedKeyValue("play_sound", play_sound);
