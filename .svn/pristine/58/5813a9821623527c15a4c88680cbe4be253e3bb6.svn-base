...
public class SmsSend {
	...
	public static String sendSMS(String phones,String templateId) throws InvalidKeyException, NoSuchAlgorithmException {
		String url = "http://www.sendcloud.net/smsapi/send";
		String smsKey = "E3IxeW2CZT5LMPukrcJSn6IDyWEf74qd";// 短信密码
		long timeIndex = System.currentTimeMillis() / 1000 / 30;
		long codes = oneTimePasswordAuthenticator.getCode(phones.getBytes(), timeIndex);
